...
def test_homepage_has_description_label():
    response = test_app.get("/")
    assert '<label for="description">Duty Description</label>' in response.text
...
def test_empty_identifier_is_not_added():
    test_app.post("/add-duty", data={
        "identifier": "",
...
def test_empty_identifier_shows_error_message():
    test_app.post("/add-duty", data={
        "identifier": "",
        "description": "Valid description"
    })
